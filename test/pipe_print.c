...
//Support For R10k
void print_stage_r10k(char* div, int inst, int npc, int valid_inst)
{
    print_stage(div,inst,npc,valid_inst);
}

//Print Reservation Station
void print_fu_select(int index, int inst, int npc, int fu_select, int op_select)
{
    printf("|  %1d  |", index);
