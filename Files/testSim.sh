...
echo "		RUNNING SIMULATION TEST SUITE" > test_results.out
...
for file in test_progs/*.s; do
	...
	grep '@@@' pipeline_simv_program.out > program.out
...
if [ "$failed" == "FALSE" ]; then
    echo "PASSED SIMULATION TEST SUITE"
    echo "		PASSED SIMULATION TEST SUITE" >> test_results.out
else
    echo "FAILED SIMULATION TEST SUITE"
    echo "		FAILED SIMULATION TEST SUITE" >> test_results.out
fi